...
const skillCategories = [
  {
    ...
    skills: ["Solidity", "Smart Contracts", "EVM", "Foundry", "Hardhat", "Hedera / HCS", "Solana", "Uniswap v4 Hooks", "Chainlink", "Cairo / Starknet", "Cosmos IBC", "Rust", "Huff", "Assembly", "ZK", "x402", "A2A / MCP", "DeFi", "NFTs", "DAOs", "RWA"],
    icon: (
  ...
  {
    title: "Agentic AI",
    skills: ["AI Agents", "Agentic Workflows", "Agentic Frameworks", "Autonomous Agents", "OpenClaw", "Hermes", "LLM Integration", "RAG", "AI Inference", "Decentralized AI", "Decentralized Compute (GPU)", "Decentralized Infrastructure (Nodes)"],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    skills: ["Smart Contract Auditing", "Smart Contract Security", "Offensive Security", "OpSec", "Rust Security", "Protocol Research", "ZK / Proof Systems", "zk-Rollups", "Fuzzing", "Echidna", "Glider", "DeFi Security", "TEE"],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
