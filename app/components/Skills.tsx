...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["Smart Contract Auditing & Security", "Offensive Security", "OpSec", "Rust Security", "Protocol Research", "ZK / Proof Systems", "zk-Rollups", "Fuzzing", "Echidna", "Glider", "DeFi Security", "TEE"],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
