...
const skillCategories = [
  ...
  {
    title: "Agentic AI",
    skills: ["AI Agents", "Agentic Workflows", "Agentic Frameworks", "Autonomous Agents", "LLM Integration", "RAG", "AI Inference", "Decentralized AI", "Decentralized Compute (GPU)", "Decentralized Infrastructure (Nodes)"],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
