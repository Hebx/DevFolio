...
const projects = [
  {
    title: "Launch.box",
    description: "A decentralized computing paradigm using autonomous AI agents to orchestrate GPU compute allocation and optimization, providing a marketplace for AI inference and node deployment.",
    image: "/Images/project.jpg",
    tags: ["AI", "Blockchain", "GPU Computing", "Web3"],
    demoUrl: "#",
    githubUrl: "#",
  ...
  },
  {
    ...
    description: "Revolutionary supply chain tracking application focused on real-time monitoring of goods movement with top-notch security and privacy, leveraging Mina's lightweight blockchain technology.",
    image: "/Images/project.jpg",
    tags: ["Mina", "zk-SNARKS", "Blockchain", "Supply Chain"],
    demoUrl: "#",
    githubUrl: "#",
  ...
  },
  {
    ...
    description: "Advanced NFT marketplace on Algorand, empowering future collectors with comprehensive testing and smart contract auditing capabilities.",
    image: "/Images/project.jpg",
    tags: ["Algorand", "NFT", "Smart Contracts", "Testing"],
    demoUrl: "#",
    githubUrl: "#",
